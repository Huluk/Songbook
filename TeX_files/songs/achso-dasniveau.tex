...
\guitarchord{Dm}
\guitarchord{E}}
\strummingTwoBeatsAndFourMovementsPerBeat{d..u.udu}
...
\begin{guitar}
	...
	\begin{highlightbar}
		\songsection{Refrain} \songsnippet{Denn ich bin ein Säufer und ein Spieler, ein gemeiner Schwätzer. ...}
	\end{highlightbar}
	...
	\begin{highlightbar}
		\songsection{Refrain} \songsnippet{Denn ich bin ein Säufer und ein Spieler, ein gemeiner Schwätz...} \optionalChord{(x2)}
	\end{highlightbar}
